...
public class pre_wedding_confirmEventFragment extends Fragment {
    ...
    public pre_wedding_confirmEventFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_pre_wedding_confirm_event, container, false);
        ...
        next.setOnClickListener(v -> {
            ...
            if (selectedPackage != null && !selectedPackage.isEmpty()) {
                ...
                // Save the total price in the database
    ...
    private void uploadImageToFirebaseStorage(Bitmap imageBitmap) {
        ...
        StorageReference imageRef = storageRef.child("downpayment_images_pre-wedding").child(filename);
            ...
            offersRef.child(packageName).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        bookingDetails.put("eventType", "pre_wedding");
